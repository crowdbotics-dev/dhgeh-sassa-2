"""
Django settings for dhgeh_sassa_2 project.
...
ROOT_URLCONF = 'dhgeh_sassa_2.urls'
...
WSGI_APPLICATION = 'dhgeh_sassa_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dhgeh_sassa_2 API",
    "DESCRIPTION": "API documentation for dhgeh_sassa_2 App",
    "VERSION": "v1",
}
